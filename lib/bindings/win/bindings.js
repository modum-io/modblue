...
const BluetoothLEDevice = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.BluetoothLEDevice;
const BluetoothCacheMode = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.BluetoothCacheMode;
const BluetoothUuidHelper = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.BluetoothUuidHelper;
const BluetoothConnectionStatus = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.BluetoothConnectionStatus;
const BluetoothLEAdvertisementWatcher = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcher;
const BluetoothLEScanningMode = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.Advertisement.BluetoothLEScanningMode;
const BluetoothLEAdvertisementType = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType;
const BluetoothLEAdvertisementDataTypes = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementDataTypes;
const BluetoothLEAdvertisementWatcherStatus = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus;
const GattCharacteristicProperties = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties;
...
const GattCommunicationStatus = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.GenericAttributeProfile.GattCommunicationStatus;
const GattClientCharacteristicConfigurationDescriptorValue = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue;
const Radio = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Radios.Radio;
const RadioKind = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Radios.RadioKind;
const RadioState = Windows === null || Windows === void 0 ? void 0 : Windows.Devices.Radios.RadioState;
const DataReader = Windows === null || Windows === void 0 ? void 0 : Windows.Storage.Streams.DataReader;
