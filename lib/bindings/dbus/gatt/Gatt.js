        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const srvPath of keys) {
                ...
                if (!service) {
                    ...
                    service = new Service_1.DbusGattService(this, srvPath, true, uuid);
    ...
    discoverCharacteristics(serviceUUID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const charPath of keys) {
                ...
                const characteristic = new Characteristic_1.DbusGattCharacteristic(service, uuid, true, properties, secure, charPath);
