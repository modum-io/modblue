...
class DbusPeripheral extends models_1.Peripheral {
    constructor(adapter, path, id, name, addressType, address, advertisement, rssi) {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.init();
            const connected = (yield this.propsIface.Get(misc_1.I_BLUEZ_DEVICE, 'Connected')).value;
            if (connected) {
