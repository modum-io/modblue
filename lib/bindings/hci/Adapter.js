...
class HciAdapter extends Adapter_1.Adapter {
    constructor() {
        super(...arguments);
        ...
        this.onDiscover = (status, address, addressType, connectable, advertisement, rssi) => {
            ...
            if (!peripheral) {
                peripheral = new Peripheral_1.HciPeripheral(this.noble, this, uuid, address, addressType, connectable, advertisement, rssi);
