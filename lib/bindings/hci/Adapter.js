...
class HciAdapter extends models_1.Adapter {
    constructor() {
        ...
        this.onDiscover = (address, addressType, connectable, advertisement, rssi) => {
            ...
            if (!peripheral) {
                peripheral = new Peripheral_1.HciPeripheral(this, uuid, adv.localName, addressType, address, adv, rssi);
    ...
    startAdvertising(deviceName, serviceUUIDs = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.gap.startAdvertising(this.deviceName, serviceUUIDs);
