...
import { GattError, GattRemote } from '../../../../models';
                    ...
                    for (let i = 0; i < num; i++) {
                        ...
                        const uuid = type === 7
                            ...
                            : data
                                ...
                                .reverse()
                                .join('');
                        const newChar = new HciGattCharacteristicRemote(service, uuid, propertiesFlag, secureFlag, charStartHandle, charValueHandle);
