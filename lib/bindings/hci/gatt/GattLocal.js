...
class HciGattLocal extends models_1.Gatt {
    ...
    setData(deviceName, services) {
        ...
        for (const service of allServices) {
            ...
            const newService = new Service_1.HciGattService(this, service.uuid, false, serviceStartHandle, 0); // End handle determined below
            const serviceHandle = { type: 'service', object: newService };
            ...
            for (const char of service.characteristics) {
                ...
                const onRead = char.onRead ? char.onRead : (offset) => __awaiter(this, void 0, void 0, function* () { return char.value.slice(offset); });
                ...
                const newChar = new Characteristic_1.HciGattCharacteristic(newService, char.uuid, false, char.properties, char.secure, charStartHandle, charValueHandle, onRead, onWrite);
                ...
                if (char.properties.includes('indicate') || char.properties.includes('notify')) {
                    ...
                    const newDescr = new Descriptor_1.HciGattDescriptor(newChar, '2902', false, clientCharacteristicConfigurationDescriptorHandle, Buffer.from([0x00, 0x00]));
                ...
                if (char.descriptors) {
                    for (const descr of char.descriptors) {
                        ...
                        const newDescr = new Descriptor_1.HciGattDescriptor(newChar, descr.uuid, false, descrHandle, descr.value);
