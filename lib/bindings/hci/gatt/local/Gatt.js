...
class HciGattLocal extends models_1.GattLocal {
            ...
            if (uuid === '2803') {
                ...
                if (secure /*&& !this._aclStream.encrypted*/) {
                    ...
                    if (handleObject instanceof models_1.GattCharacteristicLocal) {
                        [responseStatus, responseBuffer] = yield handleObject.readRequest(0);
                    }
                    else {
                ...
                if (handle.type === 'service') {
                    ...
                    if (handle.object.properties.includes('read')) {
                        if (handle.object.secure.includes('read') /*&& !this._aclStream.encrypted*/) {
                            ...
                            [result, data] = yield handle.object.readRequest(offset);
                        }
                    }
                    else {
            ...
            if (handle && handle.type !== 'service') {
                if (handle.type === 'descriptor' ||
                    ...
                    if (handle.type !== 'descriptor' &&
                        ...
                        const result = yield handle.object.writeRequest(offset, requestData, withoutResponse);
                        response =
                            result === CONST.ATT_ECODE_SUCCESS
    ...
    handlePrepareWriteRequest(_handle, _cid, request) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    handleExecuteWriteRequest(_handle, _cid, request) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error(`Method not implemented`);
            /*
            let response: Buffer = null;
    ...
    handleConfirmation(_handle, _cid, _request) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error(`Method not implemented`);
            /*
