...
class HciGatt extends models_1.GattRemote {
    constructor(noble, peripheral, hci) {
        super(noble, peripheral);
                ...
                for (let i = 0; i < num; i++) {
                    ...
                    const uuid = type === 6
                        ...
                        : data
                            ...
                            .reverse()
                            .join('');
                    const newService = new Service_1.HciService(this, uuid, srvStartHandle, srvEndHandle);
                ...
                for (let i = 0; i < num; i++) {
                    ...
                    const uuid = type === 7
                        ...
                        : data
                            ...
                            .reverse()
                            .join('');
                    const newChar = new Characteristic_1.HciCharacteristic(service, uuid, properties, charStartHandle, charValueHandle);
        ...
        while (true) {
            ...
            if (opcode === ATT_OP_FIND_INFO_RESP) {
                ...
                for (let i = 0; i < num; i++) {
                    ...
                    const newDescriptor = new Descriptor_1.HciDescriptor(characteristic, uuid, descHandle);
