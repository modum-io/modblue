...
export class HciGattRemote extends Gatt {
    ...
    doDiscoverServices() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const run = true;
            while (run) {
                const data = yield this.readByGroupRequest(startHandle, 0xffff, Codes.GATT_PRIM_SVC_UUID);
                const opcode = data[0];
    ...
    discoverCharacteristics(serviceUUID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const run = true;
            while (run) {
                const data = yield this.readByTypeRequest(startHandle, service.endHandle, Codes.GATT_CHARAC_UUID);
                const opcode = data[0];
    ...
    broadcastCharacteristic(serviceUUID, characteristicUUID, broadcast) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.readByTypeRequest(characteristic.startHandle, characteristic.endHandle, Codes.GATT_SERVER_CHARAC_CFG_UUID);
            const opcode = data[0];
            if (opcode !== Codes.ATT_OP_READ_BY_TYPE_RESP) {
    ...
    notifyCharacteristic(serviceUUID, characteristicUUID, notify) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.readByTypeRequest(characteristic.startHandle, characteristic.endHandle, Codes.GATT_CLIENT_CHARAC_CFG_UUID);
            const opcode = data[0];
            if (opcode === Codes.ATT_OP_READ_BY_TYPE_RESP) {
                const handle = data.readUInt16LE(2);
                let value = data.readUInt16LE(4);
