...
class Gap extends events_1.EventEmitter {
	constructor(hci) {
		...
		this.onHciLeAdvertisingReport = (status, type, address, addressType, eir, rssi) => {
			...
			const advertisement = (previouslyDiscovered === null || previouslyDiscovered === void 0
				? void 0
				: previouslyDiscovered.advertisement) || {
				localName: undefined,
			...
			let discoveryCount =
				(previouslyDiscovered === null || previouslyDiscovered === void 0 ? void 0 : previouslyDiscovered.count) || 0;
			let hasScanResponse =
				(previouslyDiscovered === null || previouslyDiscovered === void 0
					? void 0
					: previouslyDiscovered.hasScanResponse) || false;
			if (type === 0x04) {
