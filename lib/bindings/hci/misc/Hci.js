...
class Hci extends tiny_typed_emitter_1.TypedEmitter {
    ...
    sendCommand(data, statusOnly, customMutex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const release = customMutex ? null : yield this.acquireMutex();
    ...
    createLeConn(address, addressType, minInterval = 0x0006, maxInterval = 0x000c, latency = 0x0000, supervisionTimeout = 0x00c8) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                onComplete = (status, handle, role, _addressType, _address) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (status !== 0) {
                        const errStatus = `${hci_status_json_1.default[status]} (0x${status.toString(16).padStart(2, '0')})`;
                        yield rejectHandler(new HciError_1.HciError(`LE conn failed`, errStatus));
                        return;
                    }
                    if (role !== 0) {
                        yield rejectHandler(new HciError_1.HciError(`Could not acquire le connection as master role`));
                        return;
                    }
