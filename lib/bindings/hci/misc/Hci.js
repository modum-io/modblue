...
export class Hci extends TypedEmitter {
    ...
    acquireMutex() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new HciError(`Could not acquire HCI command mutex`, (_a = this.mutexStack) === null || _a === void 0 ? void 0 : _a.stack);
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const timeout = setTimeout(() => {
                    ...
                    reject(new HciError(`Initializing socket timed out - Are you sure it's running?`, `On unix try \`sudo hciconfig hci${this.deviceId} up\``));
