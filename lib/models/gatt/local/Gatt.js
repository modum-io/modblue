...
export class GattLocal extends Gatt {
    ...
    setData(deviceName, services) {
        ...
        for (const service of allServices) {
            ...
            for (const char of service.characteristics) {
                ...
                const newChar = new GattCharacteristicLocal(newService, char.uuid, char.properties, char.secure, onRead, onWrite, newDescriptors);
    ...
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), { maxMtu: this.maxMtu, adapter: this.adapter });
    }
}
