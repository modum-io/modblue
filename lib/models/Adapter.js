...
class Adapter extends tiny_typed_emitter_1.TypedEmitter {
     ...
     * @param timeoutInSeconds The timeout in seconds. This function will reject once the timeout is reached.
    ...
    async scanFor(isTarget, timeoutInSeconds = 10, serviceUUIDs) {
        ...
        const timeout = new Promise((_, reject) => setTimeout(() => reject(`Scan timed out`), timeoutInSeconds * 1000));
        try {
